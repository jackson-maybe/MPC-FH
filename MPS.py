...
def experiment_MPS(num_elements, provider_data_num, distribution,epsilon,delta,
    ...
    print(result_f)
    print('The shuffle distance (SD) is')
...
if __name__ == "__main__":
    ...
    experiment_MPS(num_element_sample, int(num_element_sample * proportion), distribution,epsilon,delta,m_bit,num_provider=num_provider)
